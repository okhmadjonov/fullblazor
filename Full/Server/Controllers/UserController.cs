...
namespace Full.Server.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> ForgetPassword(EmailDTO emailDto)
        {
            ...
            int otp = random.Next(1000000, 999999);

            var email = new MimeMessage();
            email.From.Add(MailboxAddress.Parse("oakhmadjonov1@gmail.com"));
            ...
            await smpt.AuthenticateAsync("oakhmadjonov1@gmail.com", "aadasdasdretrthtjffhfw4w");
